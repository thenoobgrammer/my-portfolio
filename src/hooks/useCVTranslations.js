...
const useCVTranslations = () => {
	...
	const PersonalInfo = [
		...
		{ icon: faArrowUpRightFromSquare, text: t('Montreal, QC') },
		{ icon: faArrowUpRightFromSquare, text: '+1 514-966-8481' },
		{ icon: faArrowUpRightFromSquare, text: 'ant.hakim.stud@gmail.com' },
		{ icon: faArrowUpRightFromSquare, text: `${t('English')}, ${t('French')}` },
		{ icon: faArrowUpRightFromSquare, url: PORTOFLIO_URL, text: t('My Website') },
		{ icon: faArrowUpRightFromSquare, url: LINKEDIN_URL, text: t('My LinkedIn') },
		{ icon: faArrowUpRightFromSquare, url: GITHUB_PROFILE_URL, text: t('My Github') },
	]
